...
regTheta1 =  Theta1(:,2:end);  % This step is necessary to remove biases (which are not 				regularised
...
for i = 1:m
    ...
    a3_separated = a3(i,:);
    y_separated = y(i,:);
    error3 = a3_separated - y_separated;
    error2 = Theta2'*error3'.*sigmoidGradient([1;Theta1*a1_separated']);
    del1 = del1 + error2(2:end)*a1_separated;
    del2 = del2 + error3'*a2_separated;   
end;
